...
import { StyleSheet, Image, KeyboardAvoidingView, Text, TextInput, Button, View } from 'react-native';
    ...
    return (
      ...
      <View style={styles.container}>
        <KeyboardAvoidingView keyboardVerticalOffset={50} behavior="padding">
          <Image style={{width: 375, height: 350, justifyContent: 'center'}} source={require('./sky.jpeg')} />
